...
namespace S1xxViewer.Types.Features
{
    ...
    {
        public string[] CategoryOfSignalStationWarning { get; set; }
        ...
        public override IFeature FromXml(XmlNode node, XmlNamespaceManager mgr)
        {
            ...
            var categoryOfSignalStationWarningNodes = node.FirstChild.SelectNodes("categoryOfSignalStationWarning", mgr);
            if (categoryOfSignalStationWarningNodes != null && categoryOfSignalStationWarningNodes.Count > 0)
            {
                ...
                foreach (XmlNode categoryOfSignalStationWarningNode in categoryOfSignalStationWarningNodes)
                {
                    ...
                    {
                        categories.Add(categoryOfSignalStationWarningNode.FirstChild.InnerText);
                    }
                }
